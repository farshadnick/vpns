...
config_after_install() {
    ...
    if [[ x"${config_confirm}" == x"y" || x"${config_confirm}" == x"Y" ]]; then
        read -p "Set up your account name:" config_account
        ...
        echo -e "${yellow}Your Password Would be :${config_password}${plain}"
        read -p "Port:" config_port
        echo -e "${yellow}Port Would be :${config_port}${plain}"
